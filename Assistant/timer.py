...
def startTimer(query):
	...
	playsound.playsound("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\audios\\Timer.mp3")

def timer():
	root = Tk()
	root.title("Timer")
	root.iconbitmap("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\timer.ico")
