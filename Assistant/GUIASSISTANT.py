...
if os.path.exists("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\userData\\settings.pck")==False:
	ChangeSettings(True)
	
def getChatColor():
	global chatBgColor
	chatBgColor = myColor[1] # type: ignore
...
def main(text):
		...
		if isContain(text, ['game']):
			...
			if 'online' in text:
				...
				webScrapping.openWebsite('https://poki.com/')
				return
...
def showSingleImage(type, data=None):
	...
	try:
		img0 = ImageTk.PhotoImage(Image.open('Downloads/0.jpg').resize((90,110), Image.ADAPTIVE))
	except:
		pass
	img1 = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\heads.jpg").resize((220,200),Image.ADAPTIVE))
	img2 = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\tails.jpg").resize((220,200),Image.ADAPTIVE))
	img4 = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\WeatherImage.png"))
	...
	if type=="weather":
		...
		img3 = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\dice"+type+'.jpg').resize((200,200), Image.ADAPTIVE))
...
def showImages(query):
	...
	#loading images
	img0 = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\Downloads").resize((w,h), Image.ADAPTIVE))
	img1 = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\Downloads").resize((w,h), Image.ADAPTIVE))
	img2 = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\Downloads").resize((w,h), Image.ADAPTIVE))
	img3 = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\Downloads").resize((w,h), Image.ADAPTIVE))
	#Displaying
...
def WAEMPOPUP(Service='None', rec='Reciever'):
	...
	if Service=="WhatsApp": PopUProot.iconbitmap("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\whatsapp.ico")
	else: PopUProot.iconbitmap("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\email.ico")
...
if __name__ == '__main__':
	...
	cblLightImg = PhotoImage(file="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\centralButton.png")
	cblDarkImg = PhotoImage(file="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\centralButton1.png")
	...
	#Settings Button
	sphLight = PhotoImage(file="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\setting.png")
	sphLight = sphLight.subsample(2,2)
	sphDark = PhotoImage(file="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\setting1.png")
	...
	#Keyboard Button
	kbphLight = PhotoImage(file ="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\keyboard.png" )
	kbphLight = kbphLight.subsample(2,2)
	kbphDark = PhotoImage(file = "C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\keyboard1.png")
	...
	#Mic
	micImg = PhotoImage(file ="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\mic.png")
	...
	#Text Field
	TextFieldImg = PhotoImage(file="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\textField.png")
	...
	#User and Bot Icon
	userIcon = PhotoImage(file="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\avatars\\ChatIcons\\a1"+str(ownerPhoto)+".png")
	botIcon = PhotoImage(file="C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\assistant2.png")
	...
	#User Photo
	userProfileImg = Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\avatars\\a1"+str(ownerPhoto)+".png")
	...
	cimg = PhotoImage(file = "C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\colorchooser.png")
	...
	root.iconbitmap("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\assistant2.ico")
	raise_frame(root1)
	root.mainloop()