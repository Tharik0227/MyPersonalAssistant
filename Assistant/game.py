...
def rockPaperScissorWindow():
	...
	rockImg = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\1.jpg"))
	paperImg = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\2.jpg"))
	scissorImg = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\3.jpg"))
	grayImg = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\grayQuestion.png"))
	orangeImg = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\orangeQuestion.jpg"))
	winImg = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\win.jpg"))
	loseImg = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\lose.jpg"))
	drawImg = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\draw.jpg"))
	...
	totalLabel.pack()
	#bottom image
	img = ImageTk.PhotoImage(Image.open("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\ROCKPAPERSCISSOR\\rockPaperScissor.jpg"))
	...
	root.iconbitmap("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\images\\game.ico")
	root.mainloop()
...
def play(gameName):
	...
	if isContain(gameName, ['dice','die']):
		playsound.playsound("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\audios\\dice.mp3")
		result = "You got " + str(randint(1,6))
		return result

	elif isContain(gameName, ['coin']):
		playsound.playsound("C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\extrafiles\\audios\\coin.mp3")
		p = randint(-10,10)
