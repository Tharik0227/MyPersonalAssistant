...
def maps(text):
	...
	openWebsite('https://www.google.com/maps/dir///@10.7779994,79.8498235,6z?entry=ttu/place/'+text)
...
def giveDirections(startingPoint, destinationPoint):
	...
	openWebsite('https://www.google.co.in/maps/dir/@10.8211663,78.2897649,7z?entry=ttu'+startingPoint+'/'+destinationPoint+'/')
...
def sendWhatsapp(phone_no='',message=''):
	...
	webbrowser.open('https://web.whatsapp.com/'+phone_no+'&text='+message)
	import time
...
def downloadImage(query, n=4):
	...
	for i in imgTags:
		if count==n: break
		try:
			urllib.request.urlretrieve(i['src'], "C:\\Users\\Mohamed Tharik\\Downloads\\Assistant(Chatbot)\\Assistant\\Downloads"+ str(count) + '.jpg')
			count+=1
